...
ドキュメントにサンプルのソースコードが載っています。

ドキュメント <https://github.com/udonrobo/UdonLibrary/blob/master/docs/Driver/RoboMasterMotor.md>
...
- ソースコードに対応した CAN ポートに接続されているか (写真の場合、CAN2)
